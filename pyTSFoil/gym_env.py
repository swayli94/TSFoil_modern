...
class TSFoilEnv_Empty(gym.Env):
    ...
    def render(self) -> None:
        ...
        if self.render_mode in ['save', 'both'] or self.save_frames:
    ...
    def _save_current_frame(self) -> None:
        ...
        if self.save_frames:
            ...
            self.fig.savefig(frame_path, dpi=300, bbox_inches='tight')
...
if __name__ == "__main__":
    ...
    env = TSFoilEnv_Empty(airfoil_coordinates=airfoil_coordinates)
